       ...
       <div class="dropdown-menu dropdown-menu-end py-0">
         <div class="dropdown-menu-header border-bottom">
           <div class="dropdown-header d-flex align-items-center py-3">
             <h5 class="text-body mb-0 me-auto">Shortcut Trends</h5>
             <a
               href="javascript:void(0)"
         ...
         <div class="dropdown-shortcuts-list scrollable-container">
           <div class="row row-bordered overflow-visible g-0">
             <div class="dropdown-shortcuts-item col">
               ...
               <a href="app-calendar.html" class="stretched-link">Biro Manajemen BMN dan Pengadaan</a>
               <small class="text-muted mb-0">Trend</small>
             </div>
             {{-- <div class="dropdown-shortcuts-item col">
               <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                 <i class="mdi mdi-file-document-outline fs-4"></i>
               </span>
               <a href="app-invoice-list.html" class="stretched-link">MTDI</a>
               <small class="text-muted mb-0">Trend</small>
             </div> --}}
           </div>
           <div class="row row-bordered overflow-visible g-0">
             <div class="dropdown-shortcuts-item col">
               ...
               <a href="app-user-list.html" class="stretched-link">Penatausahaan BMN</a>
               <small class="text-muted mb-0">Trend</small>
             </div>
             <div class="dropdown-shortcuts-item col">
               <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
               ...
               <a href="app-access-roles.html" class="stretched-link">Pengelolaan BMN</a>
               <small class="text-muted mb-0">Trend</small>
             </div>
           </div>
           <div class="row row-bordered overflow-visible g-0">
             <div class="dropdown-shortcuts-item col">
               ...
               <a href="index.html" class="stretched-link">Perencanaan BMN</a>
               <small class="text-muted mb-0">Trend</small>
             </div>
             <div class="dropdown-shortcuts-item col">
               <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
               ...
               <a href="pages-account-settings-account.html" class="stretched-link">Manajemen Pengadaan</a>
               <small class="text-muted mb-0">Trend</small>
             </div>
           </div>
           <div class="row row-bordered overflow-visible g-0">
             <div class="dropdown-shortcuts-item col">
               ...
               <a href="pages-faq.html" class="stretched-link">Pengembangan Strategi dan Kinerja</a>
               <small class="text-muted mb-0">Trend</small>
             </div>
             <div class="dropdown-shortcuts-item col">
               <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
               ...
               <a href="modal-examples.html" class="stretched-link">MTDI</a>
               <small class="text-muted mb-0">Trend</small>
             </div>
           </div>
         </div>
